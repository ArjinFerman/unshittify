...
<div class="mt-0 mb-4 text-xs/relaxed relative">
    <ul>
        ...
        <li class="inline-block cursor-pointer hover:text-blue-400">
            <a href="{{ route("{$entry->displayEntry()->composite_id->source->value}.entry", ['feedName' => $entry->displayEntry()->feed->handle, 'entryId' => $entry->displayEntry()->composite_id->externalId]) }}">
