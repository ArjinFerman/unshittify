...
<head>
    ...
    <style>
        :root {
            --bg-color-element: rgba(0, 32, 32, 0.7);
            --bg-color-content: rgba(0, 0, 0, 0.6);
            --bg-color-content-hover: rgba(12, 12, 12, 0.6);
...
<main class="container rounded-md w-full max-w-2xl px-6 lg:max-w-7xl mt-8 mx-auto grow">
    <div class="grid">
        @yield('content')
    </div>
</main>
...
@section('footer')
<footer class="bottom-0 left-0 right-0 bg-[var(--bg-color-element)] rounded-md p-[2rem] mt-8">
    <ul class="flex justify-between text-sm">
        <li class="flex">{{ __('Privacy Policy') }}</li>
        <li class="flex">{{ __('Github') }}</li>
    </ul>
</footer>
@show
</body></html>
