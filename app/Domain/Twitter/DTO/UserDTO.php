...
class UserDTO
{
    ...
    public static function fromUserResult(array $data): self
    {
        return new self(
            ...
            profile_background_color: $data['result']['legacy']['profile_background_color'],
            profile_banner_url: $data['result']['legacy']['profile_banner_url'],
            profile_image_url_https: $data['result']['legacy']['profile_image_url_https'],
            profile_interstitial_type: $data['result']['legacy']['profile_interstitial_type'],
            profile_link_color: $data['result']['legacy']['profile_link_color'],
